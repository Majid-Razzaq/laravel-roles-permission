                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.store') }}" method="post">
                        ...
                        <div> 
                            ...
                            <div class="my-3">
                                <input value="{{ old('title') }}" placeholder="Title" name="title" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg" >
                                @error('title')
                            ...
                            <div class="my-3">
                                <input value="{{ old('author') }}" placeholder="Author" name="author" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg" >
                                @error('author')
                                    <p class="text-red-400 font-medium">
                                        {{ $message }}
                                    </p>
